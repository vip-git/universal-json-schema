const generateSvelteFramework = ({
    ...
    Object.keys(jsonComponents).forEach((componentName) => {
        ...
        /**
         * Todo:
         * Refactor this to seperate code generation into more seperate chunks
         * Have this to be modular for each section so you can refactor things properly.
         * @param compName 
         * @param parserLocation 
         * @returns 
         */
