...
import updateFormData, { setUIData, setUISchemaData, addListItem, removeListItem, moveListItem, updateKeyFromSpec } from '../update-form-data';
...
describe('updateFormData', () => {
  ...
  describe('uiSchema', () => {
    it('updates ui Schema', () => {
      ...
      expect(setUISchemaData(initial, uiSchema, '', null)).toStrictEqual(expected);
      expect(setUISchemaData(initial, uiSchema, '', uiSchema)).toStrictEqual(expected);
    });
    it('can update ui data', () => {
      const initial = {
        name: 'Bob',
      };
      const uiSchema = {
