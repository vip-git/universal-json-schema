...
* [Documentation](docs/README.md)
  ...
  * [Validations](docs/validations/README.md)
    * [Custom Validation](docs/validations/custom-validation.md)
    * [Pattern \(Validation\)](docs/validations/pattern-validation.md)
    * [Minimum \(Validation\)](docs/validations/minimum-validation.md)
    * [Maximum \(Validation\)](docs/validations/maximum-validation.md)
    * [Min Length \(Validation\)](docs/validations/min-length-validation.md)
    * [Max Length \(Validation\)](docs/validations/max-length-validation.md)
